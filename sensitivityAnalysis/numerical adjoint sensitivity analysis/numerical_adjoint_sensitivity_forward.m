function [disp_sens, ene_sens]=numerical_adjoint_sensitivity_forward(finiteDifference,eneSens, dispSens,analysis,strMsh,homDBC,inhomDBC,NBC,bodyForces,parameters,propStrDynamics,intDomain)
...
for i=1:noNodes
    ...
    K_diff_temp = forward_finite_difference(K_in_red,K_temp_red,finiteDifference.perturbation);
    F_diff_temp = forward_finite_difference(F_in_red,F_temp_red,finiteDifference.perturbation);
