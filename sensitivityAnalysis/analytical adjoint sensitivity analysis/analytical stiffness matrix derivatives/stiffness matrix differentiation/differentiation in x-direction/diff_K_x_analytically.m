function K_diff=diff_K_x_analytically(strMsh,n,noNodes,parameters)
...
for i=1:n_elements
    ...
    if elements(i,1)==1
        K_diff_temp = diff_K_x1_CST(nodes_coord_temp,parameters);
    elseif elements(i,1)==2
        K_diff_temp = diff_K_x2_CST(nodes_coord_temp,parameters);
    elseif elements(i,1)==3
        K_diff_temp = diff_K_x3_CST(nodes_coord_temp,parameters);
    end
