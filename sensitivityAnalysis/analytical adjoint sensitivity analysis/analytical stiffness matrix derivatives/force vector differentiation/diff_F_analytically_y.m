function F_diff=diff_F_analytically_y(strMsh,NBC,node,noNodes)
...
for i=1:n_edges
    ...
    %nodal coordinates and DOFs of current element
    ...
    if edges(i,1)==1
        edge_diff=edge_diff_y1(nodes_coord_temp);
    elseif edges(i,1)==2
        edge_diff=edge_diff_y2(nodes_coord_temp);
    end
